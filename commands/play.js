...
module.exports = {
  info: {
    name: "play",
    description: "Reproduce canciones",
    usage: "<YouTube_URL> | <nombre de la canción>",
    aliases: ["p"],
  },
  ...
  run: async function (client, message, args) {
    ...
    if (!searchString)return sendError("Debes introducir una canción para buscar.", message.channel);
   ...
   var serverQueue = message.client.queue.get(message.guild.id);
    ...
    if (serverQueue) {
      ...
      .setAuthor("La canción ha sido agregada a la cola", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
