...
function generateQueueEmbed(message, queue) {
  ...
  for (let i = 0; i < queue.length; i += 10) {
    ...
    const embed = new MessageEmbed()
     .setAuthor("Cola De Reproducción", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
    ...
    .setFooter("Volumen Actual: "+serverQueue.volume)
     if(serverQueue.songs.length === 1)embed.setDescription(`No hay canciones para reproducir a continuación agregue canciones \`\`${message.client.config.prefix}play <canción>\`\``)
